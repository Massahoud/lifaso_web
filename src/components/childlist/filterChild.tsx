        ...
        <div className="flex items-center space-x-2 relative">
          ...
          {showStatePicker && (
            <div className="absolute top-12 left-0 bg-white shadow-lg rounded-lg p-4 border flex flex-col space-y-2 w-40">
              <button className="border rounded px-4 py-2 text-gray-500 hover:bg-gray-100">Nouveau</button>
              <button className="border rounded px-4 py-2 text-gray-500 hover:bg-gray-100">En cours</button>
              <button className="border rounded px-4 py-2 text-gray-500 hover:bg-gray-100">Clôturé</button>
              <div className="flex justify-between mt-2">
                <button
                  className="text-gray-600 hover:text-black text-sm"
